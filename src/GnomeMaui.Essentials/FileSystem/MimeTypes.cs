...
/// Original source: https://github.com/khellang/MimeTypes/blob/master/src/MimeTypes/MimeTypes.cs.pp
/// </summary>
public static class MimeTypes
{
	public const string DefaultFallbackMimeType = "application/octet-stream";
	private static string fallbackMimeType;
	...
	{
		get => fallbackMimeType;
		set => fallbackMimeType = value ?? DefaultFallbackMimeType;
	}

	private static readonly Dictionary<string, string> typeMap;

	public static Dictionary<string, string> TypeMap => typeMap;

	static MimeTypes()
	{
		fallbackMimeType = DefaultFallbackMimeType;

		typeMap = new Dictionary<string, string>(1180, StringComparer.OrdinalIgnoreCase)
			{
	...
	public static bool TryGetMimeType(string fileName, out string mimeType)
	{
		...
		if (dotIndex != -1 && fileName.Length > dotIndex + 1)
		{
			...
			if (typeMap.TryGetValue(extension, out var result))
			{
				mimeType = result;
				return true;
			}
