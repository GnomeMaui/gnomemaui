...
public class SkiaGraphicsView : SKDrawingArea, IDisposable
{
	RectF _dirtyRect = default;
	SignalHandler<Gtk.DrawingArea, ResizeSignalArgs>? _resizeHandler;
	...
	void OnResizeHandler(Gtk.DrawingArea area, ResizeSignalArgs args)
	{
	...
	static SkiaDirectRenderer CreateDefaultRenderer() => new();
