...
public partial class FlexLayoutTest1 : ContentPage
{
	public FlexLayoutTest1()
	{
		InitializeComponent();
	}
	...
	void OnLabel2AutoSwitchToggled(object sender, ToggledEventArgs args)
	{
		if (args.Value)
		{
			Console.WriteLine("Switch 2 On");
			FlexLayout.SetBasis(label2, FlexBasis.Auto);
		}
		else
		{
			Console.WriteLine("Switch 2 Off");
	...
	void OnLabel4AutoSwitchToggled(object sender, ToggledEventArgs args)
	{
		if (args.Value)
		{
			Console.WriteLine($"Switch 4 On: {args.Value}, Slider4: {slider4.Value}, IsRelative4: {relativeSwitch4.IsToggled}");
			FlexLayout.SetBasis(label4, FlexBasis.Auto);
		}
		else
		{
			Console.WriteLine($"Switch 4 Off: {args.Value}, Slider4: {slider4.Value}, IsRelative4: {relativeSwitch4.IsToggled}");
