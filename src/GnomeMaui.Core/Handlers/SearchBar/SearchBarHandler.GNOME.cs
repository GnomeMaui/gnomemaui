...
public partial class SearchBarHandler : ViewHandler<ISearchBar, Gtk.SearchEntry>
{
	protected override Gtk.SearchEntry CreatePlatformView() => this.Create();

	public Gtk.Entry? QueryEditor => new Gtk.Entry();
